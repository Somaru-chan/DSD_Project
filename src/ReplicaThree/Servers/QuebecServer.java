...
public class QuebecServer {
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            ServerImplementation serverImpl = new ServerImplementation(6330, 6331, 6329, "QUE");
            Endpoint ep = Endpoint.publish("http://localhost:6330/quebec", serverImpl);
    ...
    private static void runServer(ServerImplementation ServerImpl) {
        ...
        String response = "";
        try {
            socket = new DatagramSocket(6330);
            byte[] buffer = new byte[5000];
            System.out.println("Quebec UDP Server Started at 6330");
            while (true) {
