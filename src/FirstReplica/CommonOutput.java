...
public class CommonOutput {
    ...
    public static final String bookAppointment_fail_no_capacity = "No capacity in requested appointment type";
    public static final String bookAppointment_fail_weekly_limit = "Weekly limit reached";
    public static final String cancelAppointment_fail_not_registered_in_appointment = "This appointment is not registered in your account";
    ...
    public static final String swapAppointment_fail_not_registered_in_appointment = "This appointment is not registered in your account";
    ...
    public static String getAppointmentScheduleOutput(boolean isSuccess, Map<String, List<String>> appointments, String reason) {
        if (isSuccess) {
            reason = general_success;
        ...
        return standardOutput(isSuccess, "getAppointmentSchedule", reason);
    }
