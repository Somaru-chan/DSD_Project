        ...
        try {
            ...
            while (true) {
                ...
                Message Types:
                    ...
                    23-Rm3 is down
                */
                System.out.println("RM1 received a message. Detail:" + data);
                if (parts[2].equalsIgnoreCase("00")) {
                    ...
                    Runnable crash_task = () -> {
                        try {
                            ...
                            URL quebecURL = new URL("http://localhost:6231/montreal?wsdl");
                            ...
                            URL sherbrookeURL = new URL("http://localhost:6231/montreal?wsdl");
...
//                            bug_counter += 1;
    ...
    private static String requestToServers(Message input) throws Exception {
        ...
        if (input.userID.substring(3, 4).equalsIgnoreCase("A")) {
            if (input.Function.equalsIgnoreCase("addAppoint")) {
    ...
    public static void messsageToFront(String message, String FrontIpAddress) {
        ...
        DatagramSocket socket = null;
        try {
            //TODO: check if port number needs changing
    ...
    public static void reloadServers() throws Exception {
        for (ConcurrentHashMap.Entry<Integer, Message> entry : message_list.entrySet()) {
            System.out.println("Recovery Mode-RM1 is executing message request. Detail:" + entry.getValue().toString());
