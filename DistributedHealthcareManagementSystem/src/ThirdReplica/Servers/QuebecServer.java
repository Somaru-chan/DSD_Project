...
public class QuebecServer {
    ...
    private static void runServer(ServerImplementation ServerImpl) {
        ...
        String response = "";
        try {
            socket = new DatagramSocket(6230);
            byte[] buffer = new byte[5000];
            System.out.println("Quebec UDP Server Started at 6230");
            while (true) {
...
//
//    public static void main(String[] args) throws Exception{
//        Registry registry = LocateRegistry.createRegistry(6230);
//        DatagramSocket socket = new DatagramSocket(6230);
//        ServerImplementation queServerImplementation = new ServerImplementation("QUE");
//        queServerImplementation.serverName = "Quebec";
//        Naming.rebind("rmi://localhost:6230/que", queServerImplementation);
//        System.out.println("Quebec com.Servers Ready");
...
//        });
//        while(true) {
//            requestHandler(queServerImplementation, socket);
//        }
//
////		socket.close();
//    }
//    public static void requestHandler(ServerImplementation queServerImplementation, DatagramSocket socket) throws IOException{
...
//                    String result = queServerImplementation.listAppointmentAvailability(appointmentType);
...
//                    String result = queServerImplementation.bookAppointment(userID, appointmentID, appointmentType);
//                    responseReturn = result;
//                    break;
//                }
//
...
//                    //patient ID rather than user ID
//                    String result= queServerImplementation.getAppointmentSchedule(userID);
//                    responseReturn=result;
//                    break;
//                }
//
...
//                    //patient ID rather than user ID
//                    String result= queServerImplementation.cancelAppointment(userID, appointmentID);
//                    responseReturn=result;
//                    break;
//                }
//
