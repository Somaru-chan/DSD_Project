...
public class Client {
    ...
    static WebInterface serviceInterface;
    ...
    public static void runTest() throws Exception {
        ...
        Runnable addApp1 = () -> {
            String response = serviceInterface.addAppointment("MTLA808080", "Dental", 5);
            System.out.println("addAppointment(\"MTLA909090\", \"Dental\", 2) -->" + response);
        };

        Runnable bookApp1 = () -> {
            String response = serviceInterface.bookAppointment("MTLP123456", "MTLA808080", "Dental");
            System.out.println("bookAppointment(\"MTLP123456\", \"MTLA808080\", \"Dental\") -->" + response);
        };
        Runnable bookApp2 = () -> {
            String response = serviceInterface.bookAppointment("MTLP567890", "MTLA808080", "Dental");
            System.out.println("bookAppointment(\"MTLP567890\", \"MTLA808080\", \"Dental\") -->" + response);
        };
        Runnable bookApp3 = () -> {
            String response = serviceInterface.bookAppointment("MTLP654321", "MTLA808080", "Dental");
            System.out.println("bookAppointment(\"MTLP654321\", \"MTLA808080\", \"Dental\") -->" + response);
        };
        Runnable bookApp4 = () -> {
            String response = serviceInterface.bookAppointment("MTLP876543", "MTLA808080", "Dental");
            System.out.println("bookAppointment(\"MTLP876543\", \"MTLA808080\", \"Dental\") -->" + response);
        };
//
//        Runnable removeAppointment1 = () -> {
//            String response = serviceInterface.removeAppointment("MTLA101010", "Conferences");
//            System.out.println("removeAppointment(\"MTLA101010\", \"Conferences\") -->" + response);
//        };
//        Runnable removeAppointment2 = () -> {
//            String response = serviceInterface.removeAppointment("MTLE202020", "Conferences");
//            System.out.println("removeAppointment(\"MTLE202020\", \"Conferences\") -->" + response);
//        };
        ...
        if (input.length() != 10) {
            ...
            switch(input.substring(0, 3).toUpperCase().trim()){
                case "MTL":
                    ...
                    serviceInterface = montrealSer.getPort(WebInterface.class);
                    break;
                case "QUE":
                    ...
                    serviceInterface = quebecSer.getPort(WebInterface.class);
                    break;
                case "SHE":
                    ...
                    serviceInterface = sherbrookeSer.getPort(WebInterface.class);
                    break;
            }
...
//                    ClientLogger.clientLog(patientID, " attempting to bookAppointment");
                    serverResponse = serviceInterface.bookAppointment(patientID, appointmentID, appointmentType);
...
//                    ClientLogger.clientLog(patientID, " attempting to getBookingSchedule");
                    serverResponse = serviceInterface.getAppointmentSchedule(patientID);
                    System.out.println(serverResponse);
...
//                    ClientLogger.clientLog(patientID, " attempting to cancelAppointment");
                    serverResponse = serviceInterface.cancelAppointment(patientID, appointmentID, appointmentType);
                    System.out.println(serverResponse);
//                    ClientLogger.clientLog(patientID, " bookAppointment", " appointmentID: " + appointmentID + " appointmentType: " + appointmentType + " ", serverResponse);
                    break;
...
//                    ClientLogger.clientLog(patientID, " attempting to swapAppointment");
                    serverResponse = serviceInterface.swapAppointment(patientID, newAppointmentID, newAppointmentType, appointmentID, appointmentType);
                    System.out.println(serverResponse);
...
//            String appointmentID = setAppointmentID(patientID.substring(0, 4));
//            String appointment_type = set_appointment_type();
//
//            String response = serviceInterface.bookAppointment(patientID, appointmentID, appointment_type);
//            System.out.println(response);
//            patient(patientID);
//
//        } else if (action.equals("2")) {
//            String response = serviceInterface.getAppointmentSchedule(patientID);
//            System.out.println(response);
//            patient(patientID);
//        } else if (action.equals("3")) {
//            String appointmentID = setAppointmentID(patientID.substring(0, 4));
//            String appointmentType = set_appointment_type();
//            String response = serviceInterface.cancelAppointment(patientID, appointmentID, appointmentType);
//            System.out.println(response);
//            patient(patientID);
//        } else if (action.equals("4")) {
//            System.out.println("Old appointment:");
//            String oldappointmentID = setAppointmentID(patientID.substring(0, 4));
//            String oldappointmentType = set_appointment_type();
//            System.out.println("New appointment:");
//            String newappointmentID = setAppointmentID(patientID.substring(0, 4));
//            String newappointmentType = set_appointment_type();
//            String response = serviceInterface.swapAppointment(patientID, newappointmentID, newappointmentType, oldappointmentID, oldappointmentType);
//            System.out.println(response);
//            patient(patientID);
...
//                + "3.List availability of an appointment \n "
//                + "4.log in as a patient\n "
//                + "5.Exit \n");
//
//        Scanner sc = new Scanner(System.in);
//        String action = sc.nextLine();
//        if (action.equals("1")) {
//            String appointmentID = setAppointmentID(input.substring(0, 4));
//            String appointment_type = set_appointment_type();
//            System.out.println("Please choose a capacity:");
//            int booking_capacity = sc.nextInt();
//            String response = serviceInterface.addAppointment(appointmentID, appointment_type, booking_capacity);
//            System.out.println(response);
//            admin(input);
//
//        } else if (action.equals("2")) {
...
//            String response = serviceInterface.removeAppointment(appointmentID, appointment_type);
//            System.out.println(response);
//            admin(input);
//        } else if (action.equals("3")) {
//            String appointment_type = set_appointment_type();
//            String response = serviceInterface.listAppointmentAvailability(appointment_type);
//            System.out.println(response);
//            admin(input);
//        } else if (action.equals("4")) {
//            System.out.println("Please enter your user ID:");
